<template>
  <div class="container">
      ...
      <div class="positionRelative">
        ...
        <div class="slideWrapper"   @mouseleave="onMouseOut()">
          <div class="slideItem" @mouseenter="onMouseEnter(1)" >
            <img src="https://quanres.hanhoukeji.com/hanhou-ai-pc/ai_home4_item1.png"
              :class="['slideImage', slideItemHover == 1 ? 'slideImageHover' : '']" />
            <div class="slideContent">
              <span :class="['slideTitle', slideItemHover == 1 ? 'slideTitleHover' : '']"
                v-html="slideItemHover == 1 ? '在线课程学习平台' : '在线课程<br>学习平台'"></span>
              <div :class="['slideLine', slideItemHover == 1 ? 'slideLineHover' : '']"></div>
          ...
          <div class="slideItem" @mouseenter="onMouseEnter(2)">
            <img src="https://quanres.hanhoukeji.com/hanhou-ai-pc/ai_home4_item2.png"
              :class="['slideImage', slideItemHover == 2 ? 'slideImageHover' : '']" />
            <div class="slideContent">
              <span :class="['slideTitle', slideItemHover == 2 ? 'slideTitleHover' : '']"
                v-html="slideItemHover == 2 ? '定期在线直播培训' : '定期在线<br>直播培训'"></span>
              <div :class="['slideLine', slideItemHover == 2 ? 'slideLineHover' : '']"></div>
          ...
          <div class="slideItem" @mouseenter="onMouseEnter(3)">
            <img src="https://quanres.hanhoukeji.com/hanhou-ai-pc/ai_home4_item3.png"
              :class="['slideImage', slideItemHover == 3 ? 'slideImageHover' : '']" />
            <div class="slideContent">
              <span :class="['slideTitle', slideItemHover == 3 ? 'slideTitleHover' : '']"
                v-html="slideItemHover == 3 ? '企业定制培训调研' : '企业定制<br>培训调研'"></span>
              <div :class="['slideLine', slideItemHover == 3 ? 'slideLineHover' : '']"></div>
          ...
          <div class="slideItem" @mouseenter="onMouseEnter(4)">
            <img src="https://quanres.hanhoukeji.com/hanhou-ai-pc/ai_home4_item4.png"
              :class="['slideImage', slideItemHover == 4 ? 'slideImageHover' : '']" />
            <div class="slideContent">
              <span :class="['slideTitle', slideItemHover == 4 ? 'slideTitleHover' : '']"
                v-html="slideItemHover == 4 ? '企业定制培训服务' : '企业定制<br>培训服务'"></span>
              <div :class="['slideLine', slideItemHover == 4 ? 'slideLineHover' : '']"></div>
          ...
          <div class="slideItem" @mouseenter="onMouseEnter(5)">
            <img src="https://quanres.hanhoukeji.com/hanhou-ai-pc/ai_home4_item5.png"
              :class="['slideImage', slideItemHover == 5 ? 'slideImageHover' : '']" />
            <div class="slideContent">
              <span :class="['slideTitle', slideItemHover == 5 ? 'slideTitleHover' : '']"
                v-html="slideItemHover == 5 ? '企业定制培训测验' : '企业定制<br>培训测验'"></span>
              <div :class="['slideLine', slideItemHover == 5 ? 'slideLineHover' : '']"></div>
    ...
    <div class="memberFeeWrapper">
      <img src="https://quanres.hanhoukeji.com/hanhou-ai-pc/tobe_memeber.png" style="{width: 200px; height: 360px;}" />
    </div>
...
import { ElScrollbar, ElButton, ElCarousel, ElCarouselItem } from "element-plus";
