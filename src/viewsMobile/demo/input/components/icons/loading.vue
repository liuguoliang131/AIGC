...
<template>
  <div class="loader" title="loading…">
    <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px"
      y="0px" width="16px" height="16px" viewBox="0 0 16 16" style="enable-background:new 0 0 50 50;"
      xml:space="preserve">
      <rect x="0" y="2" width="2.4" height="12" :fill="color">
        <animate attributeName="opacity" attributeType="XML" values="1; .2; 1" begin="0s" dur="0.6s"
          repeatCount="indefinite" />
      </rect>
      <rect x="7" y="2" width="2.4" height="12" :fill="color">
        <animate attributeName="opacity" attributeType="XML" values="1; .2; 1" begin="0.2s" dur="0.6s"
          repeatCount="indefinite" />
      </rect>
      <rect x="14" y="2" width="2.4" height="12" :fill="color">
