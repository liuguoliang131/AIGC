<template>
  <router-view />
  <div class="banner"
    :style="{ backgroundColor: `rgba(255, 255, 255, ${useRouterConfig.titleBarOpacity})`, display: useRouterConfig.titleBar ? 'flex' : 'none' }">
    <div class="banner_left">
      <img src="@/assets/logo.png" class="logo" @click="goHome" />
      <span :class="['banner_text', useRouterConfig.currentPath == '/product_center' ? 'banner_text_selected' : '']"
        @click="goProduct">产品</span>
      <span :class="['banner_text', useRouterConfig.currentPath == '/learn_center' ? 'banner_text_selected' : '']"
...
import { ElButton, ElDialog, ElScrollbar, ElMessage, ElTabs, ElTabPane } from "element-plus";
import {
  ref
} from "vue";
